			    ...
			    <div class="card">
			      <div class="row">
			        <div class="col-md-4 pe-md-0">
			          <div class="auth-side-wrapper" style="background-image: url(../build/images/photos/img6.jpg)">
			        ...
			        <div class="col-md-8 ps-md-0">
			          <div class="auth-form-wrapper px-4 py-5">
			            ...
			            <form class="forms-sample" method="POST" action="{{route('admin.login.post')}}"> @csrf
			              <div class="mb-3">
