      ...
      <div class="card-body">
        ...
        <div class="d-flex flex-column">
          <a href="javascript:;" class="d-flex align-items-center border-bottom pb-3">
            <div class="me-3">
              <img src="build/images/faces/face2.jpg" class="rounded-circle w-35px" alt="user">
            </div>
            <div class="w-100">
          ...
          <a href="javascript:;" class="d-flex align-items-center border-bottom py-3">
            <div class="me-3">
              <img src="build/images/faces/face3.jpg" class="rounded-circle w-35px" alt="user">
            </div>
            <div class="w-100">
              <div class="d-flex justify-content-between">
          ...
          <a href="javascript:;" class="d-flex align-items-center border-bottom py-3">
            <div class="me-3">
              <img src="build/images/faces/face4.jpg" class="rounded-circle w-35px" alt="user">
            </div>
            <div class="w-100">
              <div class="d-flex justify-content-between">
          ...
          <a href="javascript:;" class="d-flex align-items-center border-bottom py-3">
            <div class="me-3">
              <img src="build/images/faces/face5.jpg" class="rounded-circle w-35px" alt="user">
            </div>
            <div class="w-100">
              <div class="d-flex justify-content-between">
          ...
          <a href="javascript:;" class="d-flex align-items-center border-bottom py-3">
            <div class="me-3">
              <img src="build/images/faces/face6.jpg" class="rounded-circle w-35px" alt="user">
            </div>
            <div class="w-100">
              <div class="d-flex justify-content-between">
